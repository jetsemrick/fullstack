...
/** One quote rendered in the scrolling ticker tape. */
...
/**
 * Batch quotes for the ticker tape (`/api/ticker-tape`).
 * Partial upstream failures are tolerated: any successfully parsed symbols are returned.
 */
