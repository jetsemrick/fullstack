 ...
 * order. Returns null when the window holds fewer than two points or has zero
 * width, so callers never show misleading stats for tiny/empty selections.
 * Series gaps resolve naturally to the nearest real points at each edge.
 */
