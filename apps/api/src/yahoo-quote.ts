...
import { MAJOR_INDEX_SYMBOLS, SP500_TAPE_SYMBOLS } from "@stock/shared";
...
export function parseQuoteResponse(
  body: unknown,
  preferredSymbols: readonly string[] = MAJOR_INDEX_SYMBOLS,
): YahooQuoteAggregate {
...
export async function fetchTickerTapeQuotes(): Promise<YahooQuoteAggregate> {
  return fetchQuotesForSymbols(SP500_TAPE_SYMBOLS);
}
