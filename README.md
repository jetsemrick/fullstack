...
Watchlists are persisted client-side in `localStorage` under `stock-visualizer.watchlists.v1`. This keeps named lists available after reloads without adding accounts or server sync.
