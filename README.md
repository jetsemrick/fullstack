...
| `apps/api` | Bun HTTP API for price history, market context, ticker tape, and bug reports |
...
- `GET /api/ticker-tape` – current prices and session changes for the curated large-cap ticker tape.
